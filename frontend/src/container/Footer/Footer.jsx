    ...
    <>
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card">
          ...
          <a href="mailto:contacto.diegoisunza@gmail.com" className="p-text">contacto.diegoisunza@gmail.com</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="mobile" />
          <a href="tel: +52 5532405062" className="p-text">+52 5532405062</a>
        </div>
      </div>
      {!isFormSubmitted 
        ? 
